...
- stop defaulting corars max tokens
...
- **agent:** use corars runtime env API (#586)
...
- **skills:** correct cora-cowork-config butler skill drift (2026-07) (#584)
...
- **mcp:** support corars config path subcommand with legacy fallback (#568)
...
- **corars:** adapt runtime guard config (#510)
...
- **agent:** support corars 0.1.31 (#503)
...
- **acp:** preserve redacted raw error in CORA_COWORK_INTERNAL_ERROR fallback (#3393)
...
- **agent:** expose corars mode config option (#501)
- **agent:** surface OpenClaw Gateway unreachable errors (#498)
- **corars:** classify engine errors structurally (#494)
- **corars:** drop malformed tool-call events (#486)
...
- **settings:** route provider health check via corars (#3058)
