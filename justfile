# CoraCowork Development Justfile
# Usage: just <recipe>
...
preflight:
    ...
    $failed = $false
    Write-Host "=========================================="
    Write-Host "  CoraCowork Build Preflight Check"
    Write-Host "=========================================="
    Write-Host ""
...
info:
    #!/usr/bin/env bash
    echo "CoraCowork Build Environment"
    echo "========================"
...
build-win: preflight
    ...
    Get-Process -Name "CoraCowork","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
