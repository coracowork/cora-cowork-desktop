...
for f in CoraCowork-1.0.0-win-x64.exe CoraCowork-1.0.0-win-arm64.exe CoraCowork-1.0.0-mac-x64.dmg CoraCowork-1.0.0-mac-arm64.dmg CoraCowork-1.0.0.deb CoraCowork-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
