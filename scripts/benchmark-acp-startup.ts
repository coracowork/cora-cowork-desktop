...
function getLogFilePath(): string {
  ...
  // Dev mode uses "CoraCowork-Dev", production uses "CoraCowork"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'CoraCowork-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'CoraCowork', `${today}.log`);
