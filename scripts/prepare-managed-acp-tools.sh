...
Environment variables:
  ...
  MANAGED_ACP_CDN_BASE         Optional. Public CDN base. Default: https://coracowork.shop/managed/acp
...
MANAGED_ACP_CDN_BASE="${MANAGED_ACP_CDN_BASE:-https://coracowork.shop/managed/acp}"
