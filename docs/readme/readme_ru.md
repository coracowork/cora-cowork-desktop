<p align="center">
  <img src="../../resources/coracowork-banner-1.png" alt="CoraCowork - Cowork with AI Agents" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/coracowork/CoraCowork?style=flat-square&color=32CD32" alt="Version">
  &nbsp;
...
<p align="center">
  <a href="https://github.com/coracowork/CoraCowork/releases">
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <strong>Русский</strong> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.coracowork.com" target="_blank">Официальный сайт</a>
</p>
...
[🤔 Почему CoraCowork?](#-why-choose-coracowork-over-claude-cowork) ·
...
**CoraCowork — это больше, чем просто клиент для чата.** Это платформа Cowork, где ИИ-агенты работают вместе с вами на вашем компьютере — читают файлы, пишут код, просматривают веб-страницы и автоматизируют задачи. Вы видите всё, что делает агент, и всегда остаётесь в управлении.

|                                        | Традиционные ИИ-чаты | **CoraCowork (Cowork)**                                                                                                      |
| :------------------------------------- | :------------------- | :----------------------------------------------------------------------------------------------------------------------- |
...
CoraCowork поставляется с полноценным движком ИИ-агента. В отличие от инструментов, требующих отдельной установки CLI-агентов, **CoraCowork работает сразу после установки**.
...
> Морфированные переходы между слайдами с согласованным повествованием; на базе [OfficeCLI](https://github.com/coracowork/CoraCLI).
...
Если вы уже используете Claude Code, Codex, Hermes Agent или OpenClaw, CoraCowork автоматически обнаружит их и позволит работать со всеми ними вместе со встроенным агентом.

**Поддерживаемые агенты:** Встроенный агент (без настройки) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, Rust-бэкенд-сервис, поставляемый с CoraCowork) • Snow CLI • Hermes Agent • Cursor Agent и другие
...
- **Параллельное выполнение нескольких агентов** — Leader разбивает задачи на подзадачи и делегирует параллельно работающим Teammate-агентам; каждый Teammate использует свою модель через ACP (Agent Communication Protocol, слой координации мультиагентности CoraCowork), Gemini или Aionrs
...
Другие ИИ-приложения дают вам чат с вашим API-ключом. **CoraCowork даёт полноценного Cowork-агента.**
...
Одни и те же возможности — чтение/запись файлов, поиск в интернете, генерация изображений, использование инструментов — независимо от того, какая модель лежит в основе. CoraCowork поддерживает **30+ ИИ-платформ**, включая облачные сервисы и локальные развёртывания.
...
CoraCowork также поддерживает шлюз-сервис [NewAPI](https://github.com/QuantumNous/new-api) — единый хаб ИИ-моделей, агрегирующий и распространяющий различные LLM. Гибкое переключение между разными моделями в одном интерфейсе для решения различных задач.
...
- **Трёхуровневые навыки** — встроенные навыки (поставляются с CoraCowork), пользовательские навыки (ваши собственные) и Extension-навыки (от сторонних расширений); включайте/отключайте для каждого разговора с помощью индикатора навыков
...
CoraCowork поддерживает три уровня навыков: **встроенные** навыки (поставляются с приложением), **пользовательские** навыки (создаются пользователем) и **навыки расширений** (загружаются через Extension SDK).
...
CoraCowork включает **21 профессиональный ассистент** с предопределёнными возможностями, расширяемыми через пользовательские навыки:
...
**Пользовательские навыки**: создавайте навыки в директории `skills/`, включайте/отключайте навыки для ассистентов, расширяя возможности ИИ. Навыки поступают из трёх источников: встроенные (поставляются с CoraCowork), пользовательские (ваши собственные) и Extension (через Extension SDK). Встроенные навыки включают `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` и другие.
...
_Ваш ИИ-ассистент 24/7 — доступ к CoraCowork с любого устройства, из любой точки мира._
...
> **Настройка:** Настройки CoraCowork → Настройки WebUI → Канал, настройте токен бота.
...
> [Руководство по удалённому доступу через интернет](https://github.com/iOfficeAI/CoraCowork/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Режим без сна** — CoraCowork автоматически предотвращает переход системы в спящий режим, пока активны задачи, и определяет пропущенные триггеры после пробуждения
...
<p align="center">
  <img src="../../resources/coracowork sort file 2.gif" alt="Smart File Management" width="800">
</p>
...
> [Руководство по конфигурации модели генерации изображений](https://github.com/iOfficeAI/CoraCowork/wiki/CoraCowork-Image-Generation-Tool-Model-Configuration-Guide)
...
<a id="-why-choose-coracowork-over-claude-cowork"></a>

## 🤔 Почему CoraCowork вместо Claude Cowork?
...
CoraCowork — это **бесплатное open-source десктопное приложение для работы с несколькими AI agents**. В отличие от Claude Cowork, который работает только на macOS и привязан к Claude, CoraCowork поддерживает разные платформы и модели.

| Параметр          | Claude Cowork  | CoraCowork                                                       |
| :---------------- | :------------- | :----------------------------------------------------------- |
...
О: <strong>Нет.</strong> В CoraCowork есть встроенный ИИ-агент, который работает сразу после установки. Просто введите любой API-ключ, чтобы начать. Если у вас также установлены CLI-инструменты, такие как Claude Code или Gemini CLI, CoraCowork автоматически обнаружит и подключит их для дополнительных возможностей.
</details>

<details>
<summary><strong>В: Что я могу делать с CoraCowork?</strong></summary>
О: CoraCowork — это ваше <strong>приватное Cowork-пространство</strong>. Встроенный агент может пакетно организовывать папки, обрабатывать данные Excel, генерировать документы, искать в интернете и генерировать изображения. В Multi-Agent Mode можно подключить Claude Code, Codex и другие мощные CLI-агенты через тот же интерфейс.
</details>

<details>
<summary><strong>В: Это бесплатно?</strong></summary>
О: CoraCowork полностью бесплатен и имеет открытый исходный код. Вы платите только за использование API выбранного провайдера и можете использовать API-ключи любого провайдера по вашему выбору.
</details>

<details>
<summary><strong>В: Можно ли запустить CoraCowork на сервере (headless)?</strong></summary>
О: Да — режим WebUI в CoraCowork работает как самостоятельный HTTP-сервер. Инструкции по настройке смотрите в разделе WebUI выше.
</details>

<details>
<summary><strong>В: Мои данные в безопасности?</strong></summary>
О: Все данные хранятся локально в базе данных SQLite. CoraCowork не загружает их на сторонние серверы.
</details>

---

## Посмотрите, как люди используют CoraCowork
...
> **Сняли видео об CoraCowork?** [Сообщите нам в X](https://x.com/CoraCowork), и мы разместим его здесь!
...
brew install coracowork
```

### Начало работы за 3 шага

1. **Установите** CoraCowork
...
- [📖 Полное руководство по установке](https://github.com/iOfficeAI/CoraCowork/wiki/Getting-Started) — подробные шаги от загрузки до настройки
- [⚙️ Руководство по настройке LLM](https://github.com/iOfficeAI/CoraCowork/wiki/LLM-Configuration) — настройка ИИ-моделей на множестве платформ
- [🤖 Настройка мультиагентного режима](https://github.com/iOfficeAI/CoraCowork/wiki/ACP-Setup) — интеграция ИИ-агентов терминала
- [🔌 Настройка MCP-инструментов](https://github.com/iOfficeAI/CoraCowork/wiki/MCP-Configuration-Guide) — настройка сервера Model Context Protocol
- [🌐 Руководство по настройке WebUI](https://github.com/iOfficeAI/CoraCowork/wiki/WebUI-Configuration-Guide) — полное руководство по настройке WebUI

**🎯 Сценарии использования**

- [📁 Управление файлами](https://github.com/iOfficeAI/CoraCowork/wiki/file-management) — умная организация файлов
- [📊 Обработка Excel](https://github.com/iOfficeAI/CoraCowork/wiki/excel-processing) — обработка данных на базе ИИ
- [🎨 Генерация изображений](https://github.com/iOfficeAI/CoraCowork/wiki/CoraCowork-Image-Generation-Tool-Model-Configuration-Guide) — создание изображений на базе ИИ
- [📚 Больше сценариев](https://github.com/iOfficeAI/CoraCowork/wiki/Use-Cases-Overview)

**❓ Поддержка и помощь**

- [❓ FAQ](https://github.com/iOfficeAI/CoraCowork/wiki/FAQ) — вопросы и устранение неполадок
- [🔧 Руководства по настройке и использованию](https://github.com/iOfficeAI/CoraCowork/wiki/Configuration-Guides) — полная документация по настройке
...
- [GitHub Discussions](https://github.com/iOfficeAI/CoraCowork/discussions) — делитесь идеями и обменивайтесь советами
- [Сообщить о проблемах](https://github.com/iOfficeAI/CoraCowork/issues) — ошибки и запросы функций
- [Обновления релизов](https://github.com/iOfficeAI/CoraCowork/releases) — получите последнюю версию
...
Локальная разработка CoraCowork использует два репозитория: CoraCowork для Electron-фронтенда и CoraCore для локального backend. Полная настройка для macOS, Linux и Windows описана в [Development Guide](../contributing/development.md).
...
<p align="center">
  <a href="https://github.com/iOfficeAI/CoraCowork/graphs/contributors">
...
<p align="center">
  <a href="https://www.star-history.com/#iOfficeAI/coracowork&Date" target="_blank">
    <img src="https://api.star-history.com/svg?repos=iOfficeAI/coracowork&type=Date" alt="Star History" width="600">
  </a>
</p>
...
[Сообщить об ошибке](https://github.com/iOfficeAI/CoraCowork/issues) · [Запросить функцию](https://github.com/iOfficeAI/CoraCowork/issues)
