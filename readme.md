...
<p align="center">
  <a href="https://github.com/coracowork/cora-cowork-desktop/releases/">
    <img src="https://img.shields.io/badge/??%20Download%20Now-Latest%20Release-32CD32?style=for-the-badge&logo=github&logoColor=white" alt="Download Latest Release" height="50">
  </a>
</p>

<p align="center">
  <strong>English</strong> | <a href="./docs/readme/readme_ch.md">????</a> | <a href="./docs/readme/readme_tw.md">????</a> | <a href="./docs/readme/readme_jp.md">???</a> | <a href="./docs/readme/readme_ko.md">???</a> | <a href="./docs/readme/readme_es.md">Español</a> | <a href="./docs/readme/readme_pt.md">Português</a> | <a href="./docs/readme/readme_tr.md">Türkçe</a> | <a href="./docs/readme/readme_ru.md">???????</a> | <a href="./docs/readme/readme_uk.md">??????????</a> | <a href="https://www.cora-cowork.com" target="_blank">Official Website</a>
</p>

<p align="center">
  <strong>?? Community:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="./resources/wx-15.png" target="_blank">?? (???)</a> | <a href="https://twitter.com/CoraCowork" target="_blank">Twitter</a>
</p>
...
[Why Choose CoraCowork?](#-why-choose-cora-cowork-over-claude-cowork) ·
...
**CoraCowork is more than a chat client.** It's a Cowork platform where AI agents work alongside you on your computer — reading files, writing code, browsing the web, and automating tasks. You see everything the agent does, and you're always in control.

|                                 | Traditional AI Chat Clients | **CoraCowork (Cowork)**                                                                                                     |
| :------------------------------ | :-------------------------- | :---------------------------------------------------------------------------------------------------------------------- |
...
CoraCowork ships with a complete AI agent engine. Unlike tools that require you to install CLI agents separately, **CoraCowork works the moment you install it**.
...
If you already use Claude Code, Codex, Hermes Agent, or OpenClaw, CoraCowork auto-detects them and lets you Cowork with all of them — alongside the built-in agent.

**Supported Agents:** Built-in Agent (zero setup) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Cora CLI (corars, the Rust-based backend service shipped with CoraCowork) • Snow CLI • Hermes Agent • Cursor Agent and more
...
- **Parallel multi-agent execution** — Leader breaks tasks into subtasks and delegates to Teammate agents running in parallel; each Teammate uses its own model via ACP (Agent Communication Protocol, CoraCowork's multi-agent coordination layer), Gemini, or Corars
- **Leader orchestration** — Leader assigns, tracks, and aggregates results; supported backends include Claude Code, Codex, Hermes Agent, Gemini, Snow CLI, and Cora CLI
...
<details>
<summary><strong>?? View Team Mode Details ??</strong></summary>

<br>

- **Shared Workspace** — all agents read/write the same folder; the file panel stays visible throughout
- **Supported backends** — Claude Code, Codex, Gemini, Snow CLI, Cora CLI (corars); other ACP backends with `mcpCapabilities.stdio` are auto-supported
...
Other AI apps give you a chatbox with your API key. **CoraCowork gives you a full Cowork agent.**
...
| AWS Bedrock credentials    | Bedrock-powered Agent via Cora CLI (corars) |
| Ollama / LM Studio (local) | Local model Cowork Agent                    |
| NewAPI Gateway             | Unified access to 20+ models                |

Same agent capabilities — file read/write, web search, image generation, tool use — regardless of which model powers it. CoraCowork supports **30+ AI platforms** including cloud services and local deployments.
...
<details>
<summary><strong>?? View All 30+ Supported Platforms ??</strong></summary>
...
CoraCowork also supports [NewAPI](https://github.com/QuantumNous/new-api) gateway service — a unified AI model hub that aggregates and distributes various LLMs. Flexibly switch between different models in the same interface to meet various task requirements.
...
- **Three-tier Skills** — Builtin skills (shipped with CoraCowork), custom skills (your own), and Extension skills (contributed by third-party extensions); enable/disable per conversation with the skill indicator
...
CoraCowork supports three skill layers: **built-in** skills (shipped with the app), **custom** skills (user-defined), and **extension** skills (loaded from the Extension SDK).

<details>
<summary><strong>?? View Assistant Details and Custom Skills ??</strong></summary>

<br>

CoraCowork includes **21 professional assistants** with predefined capabilities, extendable through custom skills:
...
**Custom Skills**: Create skills in the `skills/` directory, enable/disable skills for assistants to extend AI capabilities. Skills come from three sources: builtin (shipped with CoraCowork), custom (your own), and Extension (contributed via the Extension SDK). Built-in skills include `pptx`, `docx`, `pdf`, `xlsx`, `mermaid`, and more.
...
_Your 24/7 AI assistant — access CoraCowork from any device, anywhere._
...
- **Chat Platform Integration**
  ...
  - **WeCom (????)**, **Slack**, **Discord** and more platforms coming soon

> **Setup:** CoraCowork Settings ? WebUI Settings ? Channel, configure the Bot Token.
...
> [Remote Internet Access Tutorial](https://github.com/coracowork/cora-cowork-desktop/wiki/Remote-Internet-Access-Guide-Chinese)
...
<details>
<summary><strong>?? View Scheduled Task Details ??</strong></summary>
...
- **Keep-awake** — CoraCowork automatically prevents system sleep while tasks are active, and detects missed triggers after wake
...
<details>
<summary><strong>?? View Complete Format List ??</strong></summary>
...
<details>
<summary><strong>?? View File Management Features Details ??</strong></summary>
...
<details>
<summary><strong>?? View Excel Processing Features ??</strong></summary>
...
<details>
<summary><strong>?? View Image Generation Features ??</strong></summary>
...
> [Image generation model configuration guide](https://github.com/coracowork/cora-cowork-desktop/wiki/CoraCowork-Image-Generation-Tool-Model-Configuration-Guide)
...
<details>
<summary><strong>?? View Document Generation Features ??</strong></summary>
...
## ?? Why Choose CoraCowork Over Claude Cowork?
...
CoraCowork is a **free and open-source Multi-AI Agent Desktop**. Compared to Claude Cowork which only runs on macOS and is locked to Claude, CoraCowork is its full-model, cross-platform enhanced version.

| Dimension     | Claude Cowork | CoraCowork                                                    |
| :------------ | :------------ | :-------------------------------------------------------- |
...
A: <strong>No.</strong> CoraCowork has a built-in AI agent that works immediately after installation. Just enter any API key to get started. If you also have CLI tools like Claude Code or Gemini CLI installed, CoraCowork will auto-detect and integrate them for even more capabilities.
</details>

<details>
<summary><strong>Q: What can I do with CoraCowork?</strong></summary>
A: CoraCowork is your <strong>private Cowork workspace</strong>. The built-in agent can batch organize folders, process Excel data, generate documents, search the web, and generate images. With Multi-Agent Mode, you can also leverage Claude Code, Codex, and other powerful CLI agents through the same interface.
</details>

<details>
<summary><strong>Q: Is it free?</strong></summary>
A: CoraCowork is completely free and open source. You only pay for the API usage of whichever provider you choose, and you can use API keys from any provider you prefer.
</details>

<details>
<summary><strong>Q: Can I run CoraCowork on a server (headless)?</strong></summary>
A: Yes — CoraCowork WebUI mode runs as a standalone HTTP server. See the WebUI section above for setup instructions.
</details>
...
> **Made a video about CoraCowork?** [Let us know on X](https://x.com/CoraCowork) and we'll feature it here!
...
- [?? Complete Installation Guide](https://github.com/coracowork/cora-cowork-desktop/wiki/Getting-Started) — Detailed steps from download to configuration
- [?? LLM Configuration Guide](https://github.com/coracowork/cora-cowork-desktop/wiki/LLM-Configuration) — Multi-platform AI model configuration
- [?? Multi-Agent Mode Setup](https://github.com/coracowork/cora-cowork-desktop/wiki/ACP-Setup) — Integrate terminal AI agents
- [?? MCP Tool Configuration](https://github.com/coracowork/cora-cowork-desktop/wiki/MCP-Configuration-Guide) — Model Context Protocol server setup
- [?? WebUI Configuration Guide](https://github.com/coracowork/cora-cowork-desktop/wiki/WebUI-Configuration-Guide) — Complete WebUI setup and configuration tutorial

**?? Use Cases**

- [?? File Management](https://github.com/coracowork/cora-cowork-desktop/wiki/file-management) — Smart file organization
- [?? Excel Processing](https://github.com/coracowork/cora-cowork-desktop/wiki/excel-processing) — AI-driven data processing
- [?? Image Generation](https://github.com/coracowork/cora-cowork-desktop/wiki/CoraCowork-Image-Generation-Tool-Model-Configuration-Guide) — AI image creation
- [?? More Use Cases](https://github.com/coracowork/cora-cowork-desktop/wiki/Use-Cases-Overview)

**? Support & Help**

- [? FAQ](https://github.com/coracowork/cora-cowork-desktop/wiki/FAQ) — Questions and troubleshooting
- [?? Configuration & Usage Tutorials](https://github.com/coracowork/cora-cowork-desktop/wiki/Configuration-Guides) — Complete configuration documentation
...
- [GitHub Discussions](https://github.com/coracowork/cora-cowork-desktop/discussions) — share ideas and exchange tips
- [Report Issues](https://github.com/coracowork/cora-cowork-desktop/issues) — bugs and feature requests
- [Release Updates](https://github.com/coracowork/cora-cowork-desktop/releases/) — get the latest version
...
CoraCowork local development uses two repositories: CoraCowork for the Electron frontend and CoraCore for the local backend. See the [Development Guide](docs/contributing/development.md) for the full macOS, Linux, and Windows setup.
...
[Report Bug](https://github.com/coracowork/cora-cowork-desktop/issues) · [Request Feature](https://github.com/coracowork/cora-cowork-desktop/issues)
