...
describe('buildSendFailureError', () => {
  it('classifies 409 already-processing as CORA_COWORK_CONVERSATION_BUSY (wait, not retry)', () => {
  ...
  it('falls back to CORA_COWORK_INTERNAL_ERROR for non-conflict 409 (different message)', () => {
  ...
  it('falls back to CORA_COWORK_INTERNAL_ERROR for non-HTTP errors', () => {
