// Core types for @cora-cowork/web-host (M3 interface contract, locked for M4-M8)
...
/**
 * System dirs exported to the backend via CORA_COWORK_{CACHE,WORK,LOG}_DIR env.
