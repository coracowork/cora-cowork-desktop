# @cora-cowork/web-host

WebUI host package for CoraCowork - zero Electron dependency.

## Responsibilities

- **backend-launcher**: spawn or reuse existing CoraCore process
...
const handle = await startWebHost({
  ...
  backend: {
    kind: 'ownBackend',
    resolveBackend: () => '/path/to/CoraCore',
  },
});
