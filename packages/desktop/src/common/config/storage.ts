 ...
 * 会话来源类型 - 标识会话创建的来源
 */
export type ConversationSource = 'cora-cowork' | 'telegram' | 'lark' | 'dingtalk' | 'weixin' | 'wecom' | (string & {});
...
interface IChatConversation<T, Extra> {
  ...
  /** 会话来源，默认为 cora-cowork / Conversation source, defaults to cora-cowork */
...
export type TChatConversation =
  ...
  // CoraCore/crates/cora-cowork-common/src/enums.rs and factory.rs.
...
export interface IMcpServer {
  ...
  /** Built-in MCP server managed by CoraCowork (hide edit/delete in UI) */
  builtin?: boolean;
}
...
export const BUILTIN_IMAGE_GEN_NAME = 'cora-cowork-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['CoraCowork Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
