...
export const STORAGE_KEYS = {
  ...
  WORKSPACE_TREE_COLLAPSE: 'cora-cowork_workspace_collapse_state',

  /** Sidebar collapse state / 侧边栏折叠状态 */
  SIDEBAR_COLLAPSE: 'cora-cowork_sider_collapsed',

  /** Theme preference / 主题偏好 */
  THEME: 'cora-cowork_theme',

  /** Language preference / 语言偏好 */
  LANGUAGE: 'cora-cowork_language',
} as const;
