...
/** 临时文件时间戳分隔符 */
export const CORA_COWORK_TIMESTAMP_SEPARATOR = '_cora-cowork_';

/** 用于匹配和清理时间戳后缀的正则表达式 */
export const CORA_COWORK_TIMESTAMP_REGEX = /_cora-cowork_\d{13}(\.\w+)?$/;
export const CORA_COWORK_FILES_MARKER = '[[CORA_COWORK_FILES]]';
