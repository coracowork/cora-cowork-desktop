...
export const IMAGE_GEN_ENV_KEYS = {
  providerId: 'CORA_COWORK_IMG_PROVIDER_ID',
  platform: 'CORA_COWORK_IMG_PLATFORM',
  baseUrl: 'CORA_COWORK_IMG_BASE_URL',
  apiKey: 'CORA_COWORK_IMG_API_KEY',
  model: 'CORA_COWORK_IMG_MODEL',
} as const;
