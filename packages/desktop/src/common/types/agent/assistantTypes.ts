...
// Mirror of cora-cowork-api-types/src/assistant.rs.
...
export function isCorarsAssistant(assistant?: Pick<Assistant, 'agent'> | null): boolean {
  return assistant?.agent?.type === 'corars';
}
