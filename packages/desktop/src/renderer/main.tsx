  ...
  void import('@sentry/electron/renderer')
    .then((Sentry) => {
      Sentry.withScope((scope) => {
        scope.setTag('cora-cowork.installation_integrity', event.failure_kind ?? 'unknown');
        scope.setTag('cora-cowork.runtime_resource', event.resource);
        scope.setTag('cora-cowork.runtime_resource_id', event.resource_id ?? '');
        scope.setTag('cora-cowork.runtime_scope', event.scope.kind);
