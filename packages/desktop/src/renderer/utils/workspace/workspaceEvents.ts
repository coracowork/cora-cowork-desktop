export const WORKSPACE_TOGGLE_EVENT = 'cora-cowork-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'cora-cowork-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'cora-cowork-workspace-has-files';
