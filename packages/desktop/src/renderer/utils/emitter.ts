...
interface EventTypes {
  'corars.selected.file': [Array<string | FileOrFolderItem>];
  'corars.selected.file.append': [Array<string | FileOrFolderItem>];
  'corars.selected.file.clear': void;
  'corars.workspace.refresh': void;
