 ...
 * @param agentKey - current provider-based agent (currently only 'corars')
 */
export const useGuidModelSelection = (agentKey: ProviderAgentKey = 'corars'): GuidModelSelectionResult => {
