...
const CorarsChat = React.lazy(() => import('@/renderer/pages/conversation/platforms/corars/CorarsChat'));
...
// Narrow to Corars conversations so model field is always available
...
/** Corars sub-component manages model selection state without adding a ChatLayout wrapper */
const CorarsTeamChat: React.FC<{
  conversation: CorarsConversation;
  ...
  const modelSelection = useCorarsModelSelection({ initialModel: conversation.model, onSelectModel });
    ...
    switch (conversation.type) {
      ...
      case 'corars':
        return (
          <CorarsTeamChat
            key={conversation.id}
            conversation={conversation as CorarsConversation}
            emptySlot={emptySlot}
