...
import CoraCoworkSteps from '@/renderer/components/base/CoraCoworkSteps';
  ...
  return (
    ...
    >
      <div className='flex min-h-0 flex-col'>
        ...
        <div className='mb-6'>
          <CoraCoworkSteps current={currentStep} size='small'>
            <CoraCoworkSteps.Step
            ...
            />
            <CoraCoworkSteps.Step title={t('settings.mcpStepImportSuccess')} />
          </CoraCoworkSteps>
        </div>
