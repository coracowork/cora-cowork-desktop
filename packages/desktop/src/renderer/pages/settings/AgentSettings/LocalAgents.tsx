...
const LOCAL_AGENT_SETUP_GUIDE_URL = 'https://github.com/coracowork/cora-cowork-desktop/wiki/ACP-Setup';
...
const LocalAgents: React.FC = () => {
  ...
  const sortedOfficialAgents = [...officialAgents].toSorted((left, right) => {
    const leftIsCorars = left.agent_type === 'corars' || left.backend === 'corars';
    const rightIsCorars = right.agent_type === 'corars' || right.backend === 'corars';
    if (leftIsCorars !== rightIsCorars) {
      return leftIsCorars ? -1 : 1;
    }
