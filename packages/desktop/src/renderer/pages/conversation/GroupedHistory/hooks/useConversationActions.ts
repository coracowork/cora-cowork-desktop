...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via CoraCoworkModal in the GroupedHistory component.
   * Uses project's design system: CoraCoworkModal component with danger-styled action button.
   */
