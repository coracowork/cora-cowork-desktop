...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'cora-cowork_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'cora-cowork:workspace-expansion-changed';
