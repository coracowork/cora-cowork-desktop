...
const CorarsModelSelector: React.FC<{
  selection?: CorarsModelSelection;
  disabled?: boolean;
  ...
  // corars models are grouped by provider. Use a composite id (see compositeId)
...
export default CorarsModelSelector;
