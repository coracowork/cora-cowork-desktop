  ...
  const linkItems: LinkItem[] = [
    {
      ...
      url: 'https://github.com/coracowork/cora-cowork-desktop/wiki',
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.updateLog'),
      url: 'https://github.com/coracowork/cora-cowork-desktop/releases',
      icon: <Right theme='outline' size='16' />,
    },
    {
    ...
    },
    {
      ...
      url: 'mailto:coracowork@gmail.com',
      icon: <Right theme='outline' size='16' />,
    },
{
  title: t('settings.officialWebsite'),
  url: 'https://coracowork.shop/',
  icon: <Right theme='outline' size='16' />,
},
  ];
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            <div className='flex items-center justify-center gap-8px mb-16px'>
              ...
              <div
                ...
                onClick={() =>
                  openLink('https://github.com/coracowork/cora-cowork-desktop/').catch((error) =>
