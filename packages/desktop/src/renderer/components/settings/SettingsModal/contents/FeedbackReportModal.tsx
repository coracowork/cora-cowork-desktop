...
const FeedbackReportModal: React.FC<FeedbackReportModalProps> = ({
  ...
  // "Solve via chat": hand the report to the CoraCowork Butler for on-the-spot
  ...
  return (
    <CoraCoworkModal
      ...
      // CoraModal (e.g. the Agent editor). Arco's default z-index stacks
