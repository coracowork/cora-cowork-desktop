...
const DINGTALK_DEV_DOCS_URL = 'https://github.com/coracowork/cora-cowork-desktop/wiki/DingTalk-Bot-Setup-Guide';
...
const DingTalkConfigForm: React.FC<DingTalkConfigFormProps> = ({ pluginStatus, modelSelection, onStatusChange }) => {
  ...
  const showModelSelector = isCorarsAssistant(selectedAssistant);
