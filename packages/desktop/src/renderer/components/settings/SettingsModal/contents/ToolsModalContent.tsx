...
const ToolsModalContent: React.FC = () => {
  ...
  return (
    <div className='flex flex-col h-full w-full'>
      ...
      {/* Content Area */}
      <CoraCoworkScrollArea className='flex-1 min-h-0 pb-16px' disableOverflow={isPageMode}>
                ...
                {imageGenerationModelList.length > 0 ? (
                  ...
                  >
                    {imageGenerationModelList.map(({ models, ...platform }) => (
                      <CoraCoworkSelect.OptGroup label={platform.name} key={platform.id}>
                        {models.map((modelName) => (
                          <CoraCoworkSelect.Option key={platform.id + modelName} value={platform.id + '|' + modelName}>
                            {modelName}
                    ...
                    <Tooltip
                      content={
                        <div>
                          ...
                          <a
                            href='https://github.com/coracowork/cora-cowork-desktop/wiki/CoraCowork-Image-Generation-Tool-Model-Configuration-Guide'
                            target='_blank'
