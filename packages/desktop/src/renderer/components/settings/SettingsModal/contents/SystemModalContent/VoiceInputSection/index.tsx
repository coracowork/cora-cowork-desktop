        ...
        <>
          ...
          <Form layout='horizontal' labelAlign='left' className='space-y-12px'>
            <Form.Item label={t('settings.speechToTextSource')}>
              <CoraCoworkSelect value={source} onChange={handleSourceChange}>
                <CoraCoworkSelect.Option value='openai'>{t('settings.speechToTextSourceOpenAI')}</CoraCoworkSelect.Option>
                <CoraCoworkSelect.Option value='deepgram'>{t('settings.speechToTextSourceDeepgram')}</CoraCoworkSelect.Option>
                <CoraCoworkSelect.Option value='custom'>{t('settings.speechToTextSourceCustom')}</CoraCoworkSelect.Option>
              </CoraCoworkSelect>
            </Form.Item>
            ...
            <Form.Item label={t('settings.speechToTextLanguage')}>
              <CoraCoworkSelect value={activeLanguage} onChange={handleLanguageChange}>
                {SPEECH_LANGUAGE_OPTIONS.map((option) => (
                  <CoraCoworkSelect.Option key={option.value || 'auto'} value={option.value}>
