...
export const UPDATE_AVAILABLE_EVENT = 'cora-cowork-update-available';
...
const RELEASES_PAGE_URL = 'https://github.com/coracowork/cora-cowork-desktop/releases';
...
export const useUpdateNotificationController = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('cora-cowork-open-update-modal', handleWindowOpen);
    ...
    return () => {
      removeOpenListener();
      window.removeEventListener('cora-cowork-open-update-modal', handleWindowOpen);
