...
type CoraCoworkSelectSize = NativeSelectSize | 'middle';

export interface CoraCoworkSelectProps extends NativeSelectProps {
  /** 额外的类名 / Additional class name */
  className?: string;
  /** 统一尺寸，新增 middle（32px）/ Unified size with additional "middle" (32px) */
  size?: CoraCoworkSelectSize;
}

/**
 * 基础样式类名
 * 注意：主题相关样式（背景色、边框色）在 arco-override.css 的 .cora-select 类中定义
 * Note: Theme-related styles (background, border colors) are defined in .cora-select class in arco-override.css
 */
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <CoraCoworkSelect placeholder="请选择" style={{ width: 200 }}>
 *   <CoraCoworkSelect.Option value="1">选项1</CoraCoworkSelect.Option>
 *   <CoraCoworkSelect.Option value="2">选项2</CoraCoworkSelect.Option>
 * </CoraCoworkSelect>
 *
 * // 多选 / Multiple selection
 * <CoraCoworkSelect mode="multiple" placeholder="请选择多个">
 *   <CoraCoworkSelect.Option value="1">选项1</CoraCoworkSelect.Option>
 *   <CoraCoworkSelect.Option value="2">选项2</CoraCoworkSelect.Option>
 * </CoraCoworkSelect>
 *
 * // 分组 / Grouped options
 * <CoraCoworkSelect placeholder="请选择">
 *   <CoraCoworkSelect.OptGroup label="分组1">
 *     <CoraCoworkSelect.Option value="1">选项1</CoraCoworkSelect.Option>
 *   </CoraCoworkSelect.OptGroup>
 *   <CoraCoworkSelect.OptGroup label="分组2">
 *     <CoraCoworkSelect.Option value="2">选项2</CoraCoworkSelect.Option>
 *   </CoraCoworkSelect.OptGroup>
 * </CoraCoworkSelect>
 * ```
 *
 * @see arco-override.css for theme-related styles (.cora-select)
 */
const mapSizeToNative = (size?: CoraCoworkSelectSize): NativeSelectSize | undefined => {
  if (!size) return undefined;
  if (size === 'middle') return 'default';
  return size;
};

type CoraCoworkSelectComponent = React.ForwardRefExoticComponent<CoraCoworkSelectProps & React.RefAttributes<SelectHandle>> & {
  Option: typeof Select.Option;
  OptGroup: typeof Select.OptGroup;
};

const InternalSelect = React.forwardRef<SelectHandle, CoraCoworkSelectProps>(
...
const CoraCoworkSelect = InternalSelect as CoraCoworkSelectComponent;

CoraCoworkSelect.displayName = 'CoraCoworkSelect';

// 导出子组件 / Export sub-components
CoraCoworkSelect.Option = Select.Option;
CoraCoworkSelect.OptGroup = Select.OptGroup;

export default CoraCoworkSelect;
