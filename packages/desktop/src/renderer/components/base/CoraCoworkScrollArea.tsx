 ...
 * <CoraCoworkScrollArea className="h-400px">
 *   <div>Content...</div>
 * </CoraCoworkScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <CoraCoworkScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </CoraCoworkScrollArea>
 *
 * // 双向滚动 / Both directions
 * <CoraCoworkScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </CoraCoworkScrollArea>
 * ```
 */
interface CoraCoworkScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const CoraCoworkScrollArea: React.FC<CoraCoworkScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
CoraCoworkScrollArea.displayName = 'CoraCoworkScrollArea';

export default CoraCoworkScrollArea;
