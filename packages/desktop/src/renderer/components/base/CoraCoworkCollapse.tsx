 ...
 */
export interface CoraCoworkCollapseProps {
 ...
 */
export interface CoraCoworkCollapseItemProps {
 ...
 */
const CoraCoworkCollapseItem: React.FC<CoraCoworkCollapseItemProps> = ({ children }) => <>{children}</>;
CoraCoworkCollapseItem.displayName = 'CoraCoworkCollapseItem';
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <CoraCoworkCollapse defaultActiveKey={['1']}>
 *   <CoraCoworkCollapse.Item name="1" header="面板1">
 *     内容1
 *   </CoraCoworkCollapse.Item>
 *   <CoraCoworkCollapse.Item name="2" header="面板2">
 *     内容2
 *   </CoraCoworkCollapse.Item>
 * </CoraCoworkCollapse>
 *
 * // 手风琴模式 / Accordion mode
 * <CoraCoworkCollapse accordion defaultActiveKey="1">
 *   <CoraCoworkCollapse.Item name="1" header="面板1">内容1</CoraCoworkCollapse.Item>
 *   <CoraCoworkCollapse.Item name="2" header="面板2">内容2</CoraCoworkCollapse.Item>
 * </CoraCoworkCollapse>
 *
 * // 自定义图标 / Custom icon
 * <CoraCoworkCollapse
 ...
 * ```
 */
const CoraCoworkCollapseComponent: React.FC<CoraCoworkCollapseProps> & { Item: typeof CoraCoworkCollapseItem } = ({
  children,
  className,
  defaultActiveKey,
  activeKey,
  ...
  const items = useMemo(() => {
    return React.Children.toArray(children).filter((child): child is React.ReactElement<CoraCoworkCollapseItemProps> => {
      return React.isValidElement(child) && child.type === CoraCoworkCollapseItem;
    });
  }, [children]);
...
CoraCoworkCollapseComponent.Item = CoraCoworkCollapseItem;

export default CoraCoworkCollapseComponent;
