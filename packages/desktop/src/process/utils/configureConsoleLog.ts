 ...
 *   - macOS:   ~/Library/Logs/CoraCowork/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\CoraCowork\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/CoraCowork/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
