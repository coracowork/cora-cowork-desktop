...
export const PROTOCOL_SCHEME = 'cora-cowork';

/**
 * Parse an cora-cowork:// URL into action and params.
 * Supports two formats:
 *   1. cora-cowork://add-provider?base_url=xxx&api_key=xxx
 *   2. cora-cowork://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
